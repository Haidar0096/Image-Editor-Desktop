...
import '../services/editor/editor.dart' as _i8;
...
_i1.GetIt $initGetIt(_i1.GetIt get, {String? environment, _i2.EnvironmentFilter? environmentFilter}) {
  ...
  gh.factory<_i7.Timeline<_i8.Editor>>(() => registerModule.editorTimeLine);
  gh.factory<_i9.EditorBloc>(() => _i9.EditorBloc(
      get<_i4.FilePicker>(), get<_i5.Logger>(), get<_i3.ElementIdGenerator>(), get<_i7.Timeline<_i8.Editor>>()));
  gh.factory<_i10.ScreenshotCubit>(
      () => _i10.ScreenshotCubit(get<_i4.FilePicker>(), get<_i6.ScreenshotService>(), get<_i5.Logger>()));
  return get;
}
